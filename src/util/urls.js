...
export const CONTENTIO_URL = "/contention";
export const AUDIO_URL = "/audio";
export const MOVIES_URL = WATCHIO_URL + "/movies";
export const SERIALS_URL = WATCHIO_URL + "/serials";
export const ANIME_URL = WATCHIO_URL + "/anime";
