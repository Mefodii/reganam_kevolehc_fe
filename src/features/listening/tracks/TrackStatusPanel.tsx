...
const TrackStatusPanel: React.FC<TrackStatusPanelProps> = ({ track }) => {
  ...
  return (
    ...
    >
      ...
      <SVGDroplet className={className} svgClassName='w-4' tooltip={tooltip} />
      <SVGPencil
...
export default React.memo(TrackStatusPanel) as typeof TrackStatusPanel;
